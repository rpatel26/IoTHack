...
class Database:
	def __init__(self):
		...
		self.config = {"apiKey": "AIzaSyD945OUdvQFSh95UrcTOOhJTgXGkTloX9U", "authDomain": "iothack.firebaseapp.com", "databaseURL": "https://iothack.firebaseio.com", "storageBucket": "iothack.appspot.com"}
